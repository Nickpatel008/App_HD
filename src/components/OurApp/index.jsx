        ...
        <section>
          <div class="row">
            <div class="col-lg-7 mb-4 align-self-center text-center text-lg-left">
              <h2 class="h2 mb-5">Introducing an app for mdbootstrap</h2>
              ...
              <button
                type="button"
                class="btn btn-cyan waves-effect btn-md ml-lg-0"
              >
                <i class="fab fa-apple fa-lg pr-1"></i> App Store
              </button>
              <button type="button" class="btn btn-cyan waves-effect btn-md">
                <i class="fab fa-google-play fa-lg pr-1"></i> Google Play
              </button>
            </div>
